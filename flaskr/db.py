...
def create_roster_command():
    generate_roster('laundry', '5', 'example name laundry1', '7AM', '6hours', '28/6/2022', 'No', '4')
    generate_roster('gardener', '9', 'example name gardener1', '7AM', '6hours', '28/6/2022', 'No', '4')
    generate_roster('baby sitter', '11', 'example name baby sitter1', '7AM', '6hours', '28/6/2022', 'No', '4')
    generate_roster('linen room', '15', 'example name linen room1', '7AM', '6hours', '28/6/2022', 'No', '4')
    generate_roster('public area cleaner', '18', 'example name public area cleaner1', '7AM', '6hours', '28/6/2022', 'No', '4')
    generate_roster('housekeeping', '19', 'example name housekeeping1', '7AM', '6hours', '28/6/2022', 'No', '4')
    generate_roster('receptionist', '22', 'example name receptionist1', '7AM', '6hours', '28/6/2022', 'No', '4')
    generate_roster('cashier', '23', 'example name cashier1', '7AM', '6hours', '28/6/2022', 'No', '4')
    generate_roster('concierge', '24', 'example name concierge1', '7AM', '6hours', '28/6/2022', 'No', '4')
    generate_roster('bell man', '25', 'example name bell man1', '7AM', '6hours', '28/6/2022', 'No', '4')
    generate_roster('door man', '28', 'example name door man1', '7AM', '6hours', '28/6/2022', 'No', '4')
    generate_roster('waiter', '30', 'example name waiter1', '7AM', '6hours', '28/6/2022', 'No', '4')
    generate_roster('cook assistant', '32', 'example name cook assistant1', '7AM', '6hours', '28/6/2022', 'No', '4')
    generate_roster('bartender', '36', 'example name bartender1', '7AM', '6hours', '28/6/2022', 'No', '4')
    generate_roster('food runner', '38', 'example name food runner1', '7AM', '6hours', '28/6/2022', 'No', '4')
    generate_roster('steward', '41', 'example name food steward1', '7AM', '6hours', '28/6/2022', 'No', '4')
